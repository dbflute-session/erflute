...
public class ExtendPopupMenu {
    ...
    public static ExtendPopupMenu createExtendPopupMenu(IConfigurationElement configurationElement, RealModelEditor editor)
     ...
     * @throws CoreException
     */
    public static List<ExtendPopupMenu> loadExtensions(RealModelEditor editor) throws CoreException {
