...
public abstract class DDLCreator {
    ...
    private String getDropTablespaces(ERDiagram diagram) {
        ...
        if (this.getDBManager().createTablespaceProperties() != null) {
            for (Tablespace tablespace : diagram.getDiagramContents().getTablespaceSet()) {
                if (first) {
                    ddl.append("\r\n/* Drop Tablespaces */\r\n\r\n");
                    first = false;
                }
    ...
    public String getPostDDL(ERTable table) {
        TableViewProperties commonTableProperties =
                (TableViewProperties) this.getDiagram().getDiagramContents().getSettings().getTableViewProperties();
    ...
    public String getDDL(Relationship relation) {
        ...
        ddl.append(filter(relation.getSourceTableView().getNameWithSchema(diagram.getDatabase())));
        ddl.append(" (");
    ...
    public String getDDL(Trigger trigger) {
        ...
        ddl.append(filter(this.getNameWithSchema(trigger.getSchema(), trigger.getName())));
        ddl.append(" ");
    ...
    public String getDropDDL(TableView table, Set<TableView> doneTables) {
        ...
        for (Relationship relation : table.getOutgoingRelationshipList()) {
            ...
            if (!doneTables.contains(targetTableView)) {
                ...
                String targetTableDDL = this.getDropDDL(targetTableView, doneTables);
