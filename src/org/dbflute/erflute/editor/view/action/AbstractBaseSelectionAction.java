...
public abstract class AbstractBaseSelectionAction extends SelectionAction {
    ...
    public AbstractBaseSelectionAction(String id, String text, RealModelEditor editor) {
        this(id, text, SWT.NONE, editor);
    }

    public AbstractBaseSelectionAction(String id, String text, int style, RealModelEditor editor) {
        super(editor, style);
        this.setId(id);
        this.setText(text);
