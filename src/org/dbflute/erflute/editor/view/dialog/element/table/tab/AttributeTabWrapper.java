...
import org.dbflute.erflute.editor.view.dialog.word.column.real.ColumnDialog;
...
public class AttributeTabWrapper extends ValidatableTabWrapper implements ERTableCompositeHolder {
    ...
    private void createHeader(Composite parent) {
        ...
        this.physicalNameText = CompositeFactory.createText(tableDialog, header, "label.physical.name", 1, 200, false);
        this.logicalNameText = CompositeFactory.createText(tableDialog, header, "label.logical.name", 1, 200, true);
    ...
    private void initTable(Composite parent) {
        ...
        this.tableComposite =
                new ERTableComposite(this, parent, this.copyData.getDiagram(), this.copyData, this.copyData.getColumns(), columnDialog,
        ...
        this.groupManageButton.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                ...
                if (dialog.open() == IDialogConstants.OK_ID) {
                    ...
                    Command command = new ChangeGroupCommand(tableDialog.getDiagram(), groupSet, newColumnGroups);
