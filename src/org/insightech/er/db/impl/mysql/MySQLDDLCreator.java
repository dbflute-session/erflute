...
public class MySQLDDLCreator extends DDLCreator {
    ...
    public String getPostDDL(ERTable table) {
        MySQLTableProperties commonTableProperties =
        ...
        if (this.ddlTarget.createComment) {
            String comment = this.filterComment(table.getLogicalName(), table.getDescription(), false);
    ...
    protected String getDDL(Tablespace tablespace) {
        MySQLTablespaceProperties tablespaceProperties =
