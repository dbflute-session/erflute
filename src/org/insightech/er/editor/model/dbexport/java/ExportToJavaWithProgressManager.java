...
public class ExportToJavaWithProgressManager extends ExportToJavaManager implements IRunnableWithProgress {
    ...
    public ExportToJavaWithProgressManager(ExportJavaSetting exportJavaSetting, ERDiagram diagram) {
    ...
    public void run(IProgressMonitor monitor) throws InvocationTargetException, InterruptedException {
        ...
        int count = this.diagram.getDiagramContents().getContents().getTableSet().getList().size();

        monitor.beginTask(ResourceString.getResourceString("dialog.message.export.java"), count);
