...
public class SequenceSheetGenerator extends AbstractSheetGenerator {
    ...
    public void generate(IProgressMonitor monitor, HSSFWorkbook workbook, int sheetNo, boolean useLogicalNameAsSheetName,
        ...
        for (Sequence sequence : diagram.getDiagramContents().getSequenceSet()) {
            ...
            sheetObjectMap.put(workbook.getSheetName(workbook.getSheetIndex(newSheet)), sequence);
    ...
    public int count(ERDiagram diagram) {
        return diagram.getDiagramContents().getSequenceSet().getSequenceList().size();
    }
