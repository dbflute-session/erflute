...
public abstract class AbstractSheetGenerator {
    ...
    protected Map<String, String> buildKeywordsValueMap(HSSFSheet wordsSheet, int columnNo, String[] keywords) {
        ...
        for (String keyword : keywords) {
            CellLocation location = POIUtils.findCell(wordsSheet, keyword, columnNo);
            if (location != null) {
    ...
    protected void setColumnData(Map<String, String> keywordsValueMap, ColumnTemplate columnTemplate, HSSFRow row,
        ...
        for (int columnNum : columnTemplate.columnTemplateMap.keySet()) {
            ...
            if (KEYWORD_ORDER.equals(template)) {
                ...
                value = this.getColumnValue(keywordsValueMap, normalColumn, tableView, template);
            }
    ...
    private String getKeywordValue(Map<String, String> keywordsValueMap, NormalColumn normalColumn, TableView tableView, String keyword) {
        ...
        if (KEYWORD_LOGICAL_TABLE_NAME.equals(keyword)) {
            ...
            if (normalColumn.getType() == null) {
                ...
                obj = normalColumn.getType().getAlias(tableView.getDiagram().getDatabase());
            }
    ...
    protected ColumnTemplate loadColumnTemplate(HSSFWorkbook workbook, HSSFSheet templateSheet, CellLocation location) {
        if (location == null) {
            return null;
        }
