...
public class TableSheetGenerator extends AbstractSheetGenerator {
    ...
    public void setTableData(HSSFWorkbook workbook, HSSFSheet sheet, ERTable table) {
        ...
        POIUtils.replace(sheet, KEYWORD_TABLE_DESCRIPTION,
                this.getValue(this.keywordsValueMap, KEYWORD_TABLE_DESCRIPTION, table.getDescription()));

        POIUtils.replace(sheet, KEYWORD_TABLE_CONSTRAINT,
    ...
    private void setIndexMatrix(HSSFWorkbook workbook, HSSFSheet sheet, ERTable table) {
        ...
        CellLocation physicalIndexCellLocation = POIUtils.findCell(sheet, KEYWORD_PHYSICAL_INDEX_MATRIX);
    ...
    private void setComplexUniqueKeyMatrix(HSSFWorkbook workbook, HSSFSheet sheet, ERTable table) {
        CellLocation logicalCellLocation = POIUtils.findCell(sheet, KEYWORD_LOGICAL_COMPLEX_UNIQUE_KEY_MATRIX);
    ...
    private void setIndexMatrix(HSSFWorkbook workbook, HSSFSheet sheet, ERTable table, CellLocation cellLocation,
