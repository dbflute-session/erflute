...
public class TestDataDialog extends AbstractDialog {
    ...
    private void createAllTableList(Composite composite) {
        ...
        this.allTableListWidget = new org.eclipse.swt.widgets.List(group, SWT.BORDER | SWT.V_SCROLL | SWT.MULTI);
    ...
    private void createSelectedTableTable(Composite composite) {
        ...
        this.selectedTableTable = new Table(group, SWT.FULL_SELECTION | SWT.BORDER | SWT.MULTI);
        ...
        TableColumn tableColumn = new TableColumn(this.selectedTableTable, SWT.CENTER);
        tableColumn.setWidth(200);
        tableColumn.setText(ResourceString.getResourceString("label.testdata.table.name"));

        TableColumn numColumn = new TableColumn(this.selectedTableTable, SWT.CENTER);
    ...
    private void createBottomComposite(Composite composite) {
        ...
        this.directTestDataTabWrapper = new DirectTestDataTabWrapper(this, this.tabFolder, SWT.NONE);
        this.tabWrapperList.add(this.directTestDataTabWrapper);

        this.repeatTestDataTabWrapper = new RepeatTestDataTabWrapper(this, this.tabFolder, SWT.NONE);
    ...
    private void initSelectedTableTable() {
        ...
        for (Map.Entry<ERTable, TableTestData> entry : testData.getTableTestDataMap().entrySet()) {
            ...
            TableItem tableItem = new TableItem(this.selectedTableTable, SWT.NONE);
        ...
        Display.getDefault().asyncExec(new Runnable() {
            ...
            public void run() {
                ...
                if (targetIndex != -1) {
                    ...
                    int num = directTestDataTabWrapper.getTestDataNum() + repeatTestDataTabWrapper.getTestDataNum();

                    TableItem tableItem = selectedTableTable.getItem(targetIndex);
