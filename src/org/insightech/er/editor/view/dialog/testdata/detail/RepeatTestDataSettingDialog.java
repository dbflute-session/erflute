...
public class RepeatTestDataSettingDialog extends AbstractDialog {
    ...
    protected void initialize(Composite composite) {
        ...
        this.repeatNumLabel = CompositeFactory.createLabel(composite, "label.testdata.repeat.num", 1, LABEL_WIDTH);
    ...
    private void initTemplatePanel() {
        ...
        this.template = CompositeFactory.createText(this, templatePanel, null, 6, false);
        ...
        this.from = CompositeFactory.createNumText(this, templatePanel, null, NUM_WIDTH);
        CompositeFactory.createLabel(templatePanel, "label.testdata.repeat.end");
        this.to = CompositeFactory.createNumText(this, templatePanel, null, NUM_WIDTH);
        CompositeFactory.createLabel(templatePanel, "label.testdata.repeat.increment");
        this.increment = CompositeFactory.createNumText(this, templatePanel, null, NUM_WIDTH);
    }
    ...
    private void initEnumPanel() {
        ...
        this.selects = CompositeFactory.createTextArea(this, enumPanel, null, -1, 100, 1, false);
    }
