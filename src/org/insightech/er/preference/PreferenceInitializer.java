...
public class PreferenceInitializer extends AbstractPreferenceInitializer {
    ...
    public static String getTemplatePath(String fileName) {
        ...
        String path = dataLocation.append(PreferenceInitializer.TEMPLATE_DIR).append(fileName).toOSString();
    ...
    public static String getTranslationPath(String fileName) {
        IPath dataLocation = Activator.getDefault().getStateLocation();
        String path = dataLocation.append(PreferenceInitializer.TRANSLATION_DIR).append(fileName).toOSString();
    ...
    public static void addJDBCDriver(String db, String className, String path) {
        ...
        int listSize = store.getInt(PreferenceInitializer.JDBC_DRIVER_CLASS_NAME_LIST_NUM);
    ...
    public static List<JDBCDriverSetting> getJDBCDriverSettingList() {
        ...
        for (int i = 0; i < listSize; i++) {
            String db = store.getString(PreferenceInitializer.JDBC_DRIVER_DB_NAME_PREFIX + i);
            String className = store.getString(PreferenceInitializer.JDBC_DRIVER_CLASS_NAME_PREFIX + i);
            String path = store.getString(PreferenceInitializer.JDBC_DRIVER_PATH_PREFIX + i);
    ...
    public static void clearJDBCDriverInfo() {
        ...
        int num = store.getInt(PreferenceInitializer.JDBC_DRIVER_CLASS_NAME_LIST_NUM);
    ...
    public static DBSetting getDBSetting(int no) {
        ...
        String dbsystem = store.getString(PreferenceInitializer.DB_SETTING_DBSYSTEM + no);
        String server = store.getString(PreferenceInitializer.DB_SETTING_SERVER + no);
        int portNo = store.getInt(PreferenceInitializer.DB_SETTING_PORT + no);

        String database = store.getString(PreferenceInitializer.DB_SETTING_DATABASE + no);
        String user = store.getString(PreferenceInitializer.DB_SETTING_USER + no);
        String password = store.getString(PreferenceInitializer.DB_SETTING_PASSWORD + no);
        String useDefaultDriverString = store.getString(PreferenceInitializer.DB_SETTING_USE_DEFAULT_DRIVER + no);
        String url = store.getString(PreferenceInitializer.DB_SETTING_URL + no);
        String driverClassName = store.getString(PreferenceInitializer.DB_SETTING_DRIVER_CLASS_NAME + no);
    ...
    public static List<String> getAllUserTranslations() {
        String str = Activator.getDefault().getPreferenceStore().getString(PreferenceInitializer.TRANSLATION_FILE_LIST);
